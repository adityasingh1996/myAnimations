/**
 * Morphing Particles - Modular ES6 Version
 * Refactored for multiple instances and independent configuration.
 */

// --- SHADER DEFINITIONS (Shared constants) ---
const NOISE_GLSL = `
...
async function loadLibs() {
    ...
    // Load ThreeJS, GSAP, and PDS in order
...
export class MorphingParticles {
    ...
    async setupParticles() {
        // Inner Logic Class for Particles
