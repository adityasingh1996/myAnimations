 ...
 * 2. Added resize support for vector scale.
 * 3. Window-based event listeners for robust interaction.
 */
...
void main() {
    ...
    // NOTE: uParticleScale controls the size, vScale controls lifecycle size
...
// Inline Worker for Poisson Disk Sampling calculation to avoid external file deps
const WORKER_SCRIPT = `
...
export class MorphingParticles {
    constructor(options) {
        ...
        // 1. IMAGE SIZE: Controls the scale of the vector shape (how spread out the points are)
